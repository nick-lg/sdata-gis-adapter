    ...
    static Create(options = {}) {
        ...
        switch (type) {
            ...
            case "gaode-street-offline":
                ...
                break;
            case "baidu-street-offline":
                layer = new LayerGroup({
                    id: options.id,
                    name: options.name,
                    layers: [
                        new TileLayer({
                            url: `${SDG_OFFLINE_ASSETS_PATH}/tiles/baidu-street/world/{z}/{x}/{y}.png`,
                            tileType: "bd",
                            lodMinLevel: 3,
                            lodMaxLevel: 7,
                            correct: correct
                        ...
                        new TileLayer({
                            url: `${SDG_OFFLINE_ASSETS_PATH}/tiles/baidu-dark/china/{z}/{x}/{y}.png`,
                            tileType: "bd",
                            lodMinLevel: 3,
                            lodMaxLevel: 10,
                            extent: [72, 2, 136, 55],
                ...
                break;
            case "baidu-dark-offline":
                layer = new LayerGroup({
                    id: options.id,
                    name: options.name,
                    layers: [
                        new TileLayer({
                            url: `${SDG_OFFLINE_ASSETS_PATH}/tiles/baidu-dark/world/{z}/{x}/{y}.png`,
                            tileType: "bd",
                            lodMinLevel: 3,
                            lodMaxLevel: 7,
                            correct: correct
